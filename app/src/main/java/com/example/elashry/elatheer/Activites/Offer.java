...
public class Offer extends AppCompatActivity {
    ...
    RequestQueue queue;
    String url = "https://alatheertech.com/api/find/comp_offers";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapteroffer(this, feedsList);
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        NewsFeeds feeds = new NewsFeeds(obj.getString("off_img"), obj.getString("off_title"));
    ...
    {
        ConnectivityManager cm = (ConnectivityManager)Offer.this.getSystemService(Context.CONNECTIVITY_SERVICE);
